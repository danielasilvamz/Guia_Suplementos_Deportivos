...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="css/styles_index_log.css">
    <!-- Font Awesome -->
...
<body>
                ...
                <ul class="navbar-nav mx-auto text-center">
                    ...
                    <li class="nav-item dropdown px-2 py-2">
                        ...
                        <ul class="dropdown-menu">
                            <!-- <li><a class="dropdown-item" href="catalogo.php">Proteínas</a></li> -->
    ...
    <section id="hero" class="hero vh-100" style="padding-top: 104px;">
        ...
        $sql = $conexion->query("select nombres from Usuarios where email = $usuario");
