...
<head>
    ...
    <title>Resultados de la búsqueda | Guía de Suplementos Deportivos</title>
    <!-- Favicon -->
            ...
            <div class="order-lg-2 nav-btns d-flex align-items-center">
                ...
                <form id="search-form" class="d-flex" role="search" action="resultados_busqueda.php" method="GET">
                    <div class="form-group">
                        <input type="text" class="form-control me-2" id="recuadro_buscar" name="palabraClave"
                            placeholder="Buscar" aria-label="Search" value="<?= $palabraClave ?>">
                    </div>
                    <button type="button" id="btn_buscar" class="btn text-white"><i
    ...
    <section class="catalogo" style="padding-top: 104px; padding-bottom: 50px;">
        <div class="container">
            ...
            <span class="badge bg-secondary">
                <?php echo $numRegistros; ?> resultados
            </span>
            <div class="row g-0">
                <?php
